...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IssueDetail>(entity =>
        {
            ...
            entity.Property(e => e.UpdatedRemark).HasColumnName("UPDATED_REMARK");
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.IssueDetailCreatedByNavigations)
            ...
            entity.HasOne(d => d.UpdatedByNavigation).WithMany(p => p.IssueDetailUpdatedByNavigations)
                .HasForeignKey(d => d.UpdatedBy)
                .HasConstraintName("FK_ISSUE_DETAILS_USER_MASTER1");
        });
